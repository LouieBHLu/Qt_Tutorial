...
class Login(QWidget):
    ...
    def show_signin_page_func(self):
        ...
        # exec: you can only handle the current window
        # show: you can also handle other windows instead of the current one 
...
class SigninPage(QDialog):
    # QDialog has exec_() funtion, while QWidget does not.
    def __init__(self):
